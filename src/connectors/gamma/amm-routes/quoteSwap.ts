...
export async function getRawSwapQuote(
  ...
  const [inputToken, outputToken, inputTokenReserves, outputTokenReserves] = baseTokenAddress === ammPoolInfo.baseTokenAddress 
  ...
  return {
    ...result,
    zeroForOne: baseTokenAddress === ammPoolInfo.baseTokenAddress,
